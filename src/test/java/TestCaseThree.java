...
public class TestCaseThree {
    ...
    public void testcase3(){
        ...
        String checkInDate = today.plusDays(-5).format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));

        // Set Check-out date (5 days from today)
        String checkOutDate = today.plusDays(-3).format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
